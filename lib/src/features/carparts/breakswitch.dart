...
class BreakSwitch extends StatefulWidget {
  const BreakSwitch({super.key});

  @override
  State<BreakSwitch> createState() => _BreakSwitchState();
}

class _BreakSwitchState extends State<BreakSwitch> {
